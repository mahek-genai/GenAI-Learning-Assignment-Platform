...
def main():
    ...
    st.set_page_config(
        page_title="Kaizan Home",
        page_icon="👋 ",
    )

    st.write("# Welcome to Kaizan! 👋")

    st.markdown(
        """
        This portal is a GenAI platform for Trainers to create course materials and 
        for Candidates, to learn English words and sentences.
